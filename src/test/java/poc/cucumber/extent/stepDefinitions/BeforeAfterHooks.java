package poc.cucumber.extent.stepDefinitions;
...
import poc.cucumber.extent.DriverManager;
...
public class BeforeAfterHooks {
    ...
    public void deleteAllCookies() {
        ...
        System.out.println("Plugin Name:" + System.getProperty("PluginName") + " From deleteAllCookies.");
    }
    ...
    public static void embedScreenshot(Scenario scenario) {
        System.out.println("Plugin Name:" + System.getProperty("PluginName") + " From embedScreenshot.");
