...
public class RemoteWebDriverListener implements IInvokedMethodListener {
    ...
    public void beforeInvocation(IInvokedMethod method, ITestResult testResult) {
        ...
        System.out.println("Method under consideration is: " + method);
        System.out.println("Is method under consideration is test method: " + method.isTestMethod());
        if (method.isTestMethod()) {
            // get browser name specified in the TestNG XML test suite file
            String browserName = method.getTestMethod().getXmlTest().getLocalParameters().get("browserName");
            System.out.println("In RemoteWebDriverListener, browserName fetched from TestNGXML is: " + browserName);
            URL hubURL = null;
            try {
            ...
            System.out.println("Thread is setup for: " + driver);
